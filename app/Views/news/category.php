<div class="container py-4">
    ...
    <?= itemlist_jsonld($articles, $locale, $title ?? 'Category') ?>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <h4 class="section-title">
                <?= $locale === 'hi' ? esc($category->name_hi) : esc($category->name_en) ?>
                <?php if ($category->description): ?>
                <small class="text-muted d-block fs-6 fw-normal"><?= esc($category->description) ?></small>
                <?php endif; ?>
            </h4>
            <?php endif; ?>
